...
├─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┼─────┤
│BTN1 │BTN2 │BTN3 │BTN4 │ GND │J1_X │J1_Y │+3.3 │ GND │ VCC │ GND │ A   │ B   │ Z   │ Y   │ GND │+3.3 │J2_X │J2_Y │ GND │BTN5 │BTN6 │BTN7 │BTN8 │
└─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┴─────┘
```
...
| 12  | A (TX+)  | Передача данных RS-422 (положительный) |
| 13  | B (TX-)  | Передача данных RS-422 (отрицательный) |
| 14  | Z (RX+)  | Прием данных RS-422 (положительный) |
| 15  | Y (RX-)  | Прием данных RS-422 (отрицательный) |
| 16  | GND      | Общий минус джойстика |
| 17  | +3.3     | Общий плюс джойстика |
| 18  | J2_Y     | Ось Y второго джойстика (ADC) |
| 19  | J2_X     | Ось X второго джойстика (ADC) |
