#ifndef CONFIG_CH32V003_H
#define CONFIG_CH32V003_H

// Пины для измерения импульсов и тока (CH32V003F4U6)
// CH32V003F4U6 имеет ограниченное количество пинов
...
#define SMOOTH_START_STEP_MS 10        // Интервал между шагами (мс)
#define SMOOTH_START_STEP_SIZE 8       // Размер шага скорости
#define SMOOTH_START_MIN_SPEED 10      // Минимальная скорость для плавного старта
...
// Специфичные настройки для CH32V003
#define CH32V003_SPECIFIC_SETTINGS true

#endif // CONFIG_CH32V003_H
