...
├── BUTTON1 (PB12) → поворот камеры вниз
├── BUTTON2 (PB13) → поворот камеры вверх
...
// Пины кнопок
#define BUTTON1 PB12        // Поворот камеры вниз
#define BUTTON2 PB13        // Поворот камеры вверх 
#define BUTTON3 PB14        // Открыть манипулятор
#define BUTTON4 PB15        // Закрыть манипулятор
#define BUTTON5 PB6         // Включить освещение
#define BUTTON6 PB7         // Выключить освещение
#define BUTTON7 PB8         // Зарезервировано
#define BUTTON8 PB9         // Зарезервировано
...
### Камера
- **Кнопки:** BUTTON1 (вниз), BUTTON2 (вверх)
...
### Манипулятор
- **Кнопки:** BUTTON3 (открыть), BUTTON4 (закрыть)
...
### Освещение
- **Кнопки:** BUTTON5 (включить), BUTTON6 (выключить)
- **Тип:** Мгновенное переключение
- **Состояния:**
...
### Отладочная телеметрия (Serial USB)
```
...
### Схема подключения
```
STM32F103C8T6          ADM2687E          ROV Controller
├── Serial1 (PA9)  →   TX_IN           →   RX (команды)
├── Serial1 (PA10) →   RX_OUT          →   TX (не используется)
├── RE (PA11)      →   RE              →   Управление направлением
├── DE (PA8)       →   DE              →   Управление направлением
...
- **Serial USB:** Отладочная информация при включенном DEBUG_TELEMETRY
